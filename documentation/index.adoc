...
link:https://www.sigs-datacom.de/uploads/tx_dmjournals/erker_fink_JS_06_14_Bp6d.pdf[Gut zugeschnitten - Alternativen für die Integration von SAP-Systemen mit Java EE]::
